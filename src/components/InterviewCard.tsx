      ...
      <div className="card-interview">
        <div>
          ...
          <h3 className='mt-5 capitalize'>
            ...
            <div className="felx flex-row gap-5 mt-3">
            ...
            <p className='line-clamp-2 mt-5'>{feedback?.finalAssessment || "Kamu belum mengambil interview. Ambil sekarang dan tingkatkan skill kamu."}</p>
        </div>
        ...
        <div className="flex flex-row justify-between">
          ...
          <Button className="btn-primary">
            ...
            {feedback ? "Lihat Feedback" : "Ambil Interview"}
            </Link>
          </Button>
        </div>
      </div>
